...
#
# This repo currently parses `dynamorm:"encrypted"` into model metadata. This verifier ensures the tag also has
# real semantics (write-time encryption + read-time decryption) using a provided KMS Key ARN.

roadmap="docs/development/planning/dynamorm-encryption-tag-roadmap.md"
