...
import (
	...
	"github.com/pay-theory/dynamorm-contract-tests/runners/go/internal/driver"
	"github.com/pay-theory/dynamorm-contract-tests/runners/go/internal/runner"
	"github.com/pay-theory/dynamorm-contract-tests/runners/go/internal/scenario"
	"github.com/pay-theory/dynamorm-contract-tests/runners/go/internal/spec"
)
...
func TestContract_P0(t *testing.T) {
	...
	drv, err := driver.NewDynamormDriver()
