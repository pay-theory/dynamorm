...
This guide documents how to test Python services that use `dynamorm_py`.

## Unit testing (recommended default)

Use strict fakes from `dynamorm_py.mocks` to avoid real AWS calls and to keep tests deterministic.
