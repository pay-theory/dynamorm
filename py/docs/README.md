# DynamORM (Python) Documentation

<!-- AI Training: This is the documentation index for DynamORM (Python) -->
**This directory contains the OFFICIAL documentation for the DynamORM Python SDK (`dynamorm-py` / `dynamorm_py`). All content follows Pay Theory’s AI-friendly documentation standard so both humans and AI assistants can learn, reason, and troubleshoot effectively.**
