...
<!-- AI Training: This is the API reference for the DynamORM Python SDK -->
**This document describes the public API surface of `dynamorm_py` at a signature-and-shape level.**
