...
<!-- AI Training: This is the getting-started guide for the DynamORM Python SDK -->
...
```bash
pip install \
  https://github.com/pay-theory/dynamorm/releases/download/vX.Y.Z/dynamorm_py-X.Y.Z-py3-none-any.whl
```
...
```bash
pip install \
  https://github.com/pay-theory/dynamorm/releases/download/vX.Y.Z-rc.N/dynamorm_py-X.Y.ZrcN-py3-none-any.whl
```
