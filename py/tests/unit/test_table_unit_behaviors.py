...
from dynamorm_py.model import Projection, gsi
from dynamorm_py.table import _backoff_seconds, _chunked, _map_client_error, _map_transaction_error
...
class Item:
    ...
    note: str = dynamorm_field(name="note", omitempty=True, default="")
