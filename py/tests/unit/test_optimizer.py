...
from dynamorm_py.model import ModelDefinition, dynamorm_field, gsi, lsi
from dynamorm_py.optimizer import QueryOptimizer
from dynamorm_py.query import FilterCondition
...
class User:
    ...
    sk2: str = dynamorm_field(name="SK2")
