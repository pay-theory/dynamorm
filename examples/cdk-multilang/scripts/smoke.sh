...
go_url="$(jq -r '.DynamormMultilangDemoStack.GoFunctionUrl' "${out_file}")"
node_url="$(jq -r '.DynamormMultilangDemoStack.NodeFunctionUrl' "${out_file}")"
py_url="$(jq -r '.DynamormMultilangDemoStack.PythonFunctionUrl' "${out_file}")"
table="$(jq -r '.DynamormMultilangDemoStack.TableName' "${out_file}")"
