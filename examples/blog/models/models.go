...
type SearchIndex struct {
	...
	ID          string    `dynamorm:"pk" json:"id"`
	ContentType string    `dynamorm:"index:gsi-search,pk" json:"content_type"`
	SearchTerms string    `dynamorm:"index:gsi-search,sk" json:"search_terms"`
...
type PostView struct {
	...
	TTL       time.Time `dynamorm:"ttl" json:"ttl"`
	ID        string    `dynamorm:"pk" json:"id"`
	PostID    string    `json:"post_id"`
