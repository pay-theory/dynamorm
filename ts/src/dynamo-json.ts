...
export function toDynamoJson(av: AttributeValue): unknown {
  ...
  throw new DynamormError('ErrInvalidModel', 'Invalid AttributeValue JSON');
}
...
export function fromDynamoJson(input: unknown): AttributeValue {
  ...
  switch (k) {
    case 'S':
      if (typeof v !== 'string')
        throw new DynamormError('ErrInvalidModel', 'Invalid S value');
      return { S: v };
    case 'N':
      if (typeof v !== 'string')
        throw new DynamormError('ErrInvalidModel', 'Invalid N value');
      return { N: v };
    case 'BOOL':
      if (typeof v !== 'boolean')
        throw new DynamormError('ErrInvalidModel', 'Invalid BOOL value');
      return { BOOL: v };
    case 'NULL':
      if (v !== true)
        throw new DynamormError('ErrInvalidModel', 'Invalid NULL value');
      return { NULL: true };
    case 'SS':
      if (!Array.isArray(v) || v.some((x) => typeof x !== 'string')) {
        throw new DynamormError('ErrInvalidModel', 'Invalid SS value');
      }
      return { SS: v as string[] };
    case 'NS':
      if (!Array.isArray(v) || v.some((x) => typeof x !== 'string')) {
        throw new DynamormError('ErrInvalidModel', 'Invalid NS value');
      }
      return { NS: v as string[] };
    case 'B':
      if (typeof v !== 'string')
        throw new DynamormError('ErrInvalidModel', 'Invalid B value');
      return { B: Buffer.from(v, 'base64') };
    case 'BS':
      if (!Array.isArray(v) || v.some((x) => typeof x !== 'string')) {
        throw new DynamormError('ErrInvalidModel', 'Invalid BS value');
      }
      return { BS: (v as string[]).map((s) => Buffer.from(s, 'base64')) };
    case 'L':
      if (!Array.isArray(v))
        throw new DynamormError('ErrInvalidModel', 'Invalid L value');
      return { L: (v as unknown[]).map(fromDynamoJson) };
    case 'M': {
      if (!v || typeof v !== 'object' || Array.isArray(v)) {
        throw new DynamormError('ErrInvalidModel', 'Invalid M value');
      }
