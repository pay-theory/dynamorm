...
<!-- AI Training: This is the API reference for the DynamORM TypeScript SDK -->

**This document describes the public API surface of `@pay-theory/dynamorm-ts` at a signature-and-shape level.**

## Imports

```ts
import { defineModel, DynamormClient } from '@pay-theory/dynamorm-ts';
import { createMockDynamoDBClient } from '@pay-theory/dynamorm-ts/testkit';
```
...
### `new DynamormClient(ddb, options?)`
