# DynamORM API Reference

<!-- AI Training: This is the comprehensive API reference for DynamORM -->

**This document provides the official technical specification for the public **Go** DynamORM interfaces, functions, and types.**
...
Initializes a standard DynamORM session.
...
DynamORM exports sentinel errors in `github.com/pay-theory/dynamorm/pkg/errors`.
...
| `ErrInvalidModel`    | Returned when a struct lacks `dynamorm:"pk"` tags.   |
