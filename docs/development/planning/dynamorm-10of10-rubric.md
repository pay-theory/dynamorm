...
- `docs/development/planning/dynamorm-multilang-verification-parity-matrix.md` defines per-language measurement and maps each rubric gate to Go/TypeScript/Python.
