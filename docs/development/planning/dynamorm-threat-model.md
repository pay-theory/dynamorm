...
- **Important note:** `dynamorm:"encrypted"` has enforced field-level encryption semantics and fails closed unless `session.Config.KMSKeyARN` is configured (see `docs/development/planning/dynamorm-encryption-tag-roadmap.md`).
