# DynamORM: Multi-language Verification Parity Matrix (Go / TypeScript / Python)
...
- Verification roadmap: `docs/development/planning/dynamorm-multilang-verification-parity-roadmap.md`
- Feature parity: `docs/development/planning/dynamorm-multilang-feature-parity-matrix.md`
...
- **Library code scope (coverage):** `py/src/dynamorm_py/**` (exclude `py/tests/**`, `py/examples/**`, `py/dist/**`).
