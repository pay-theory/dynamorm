...
type fuzzMarshalModel struct {
	...
	Str   string            `dynamorm:"omitempty" json:"str,omitempty"`
	Tags  []string          `dynamorm:"omitempty" json:"tags,omitempty"`
	Attrs map[string]string `dynamorm:"omitempty" json:"attrs,omitempty"`
	Blob  []byte            `dynamorm:"omitempty" json:"blob,omitempty"`
	Num   int64             `dynamorm:"omitempty" json:"num,omitempty"`
}
