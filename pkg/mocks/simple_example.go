// Package mocks - Simple DynamORM Mocking Example
//
// This file demonstrates the basics of DynamORM mocking with a simple,
...
// This is just a regular DynamORM model
type User struct {
...
// 🚀 STEP 2: Create a service that uses DynamORM
// This is the real business logic you want to test
type UserService struct {
	db core.DB // This is the DynamORM database interface
}
...
1. Import the mocks: import "github.com/pay-theory/dynamorm/pkg/mocks"
