...
type demoModel struct {
	...
	Value  string `dynamorm:"attr:value,omitempty"`
	Secret string `dynamorm:"encrypted,attr:secret,omitempty"`
}
...
type pkOnlyModel struct {
	...
	Flag bool     `dynamorm:"attr:flag,omitempty"`
}
...
type indexKeyTypeModel struct {
	GSI1PK string `dynamorm:"attr:gsi1PK,index:gsi-keytype,pk"`
	SK     []byte `dynamorm:"sk,attr:SK"`
	PK     int64  `dynamorm:"pk,attr:PK"`
	GSI1SK int    `dynamorm:"attr:gsi1SK,index:gsi-keytype,sk"`
}
