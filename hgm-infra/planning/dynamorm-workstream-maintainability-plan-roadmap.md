# dynamorm: maintainability-plan Roadmap (Rubric v0.1)
...
Acceptance criteria:
- Add `hgm-infra/planning/dynamorm-maintainability-roadmap.md` with at least:
  - Baseline snapshot
  - Hotspots
...
## Notes
- Update `hgm-infra/planning/dynamorm-10of10-roadmap.md` once MAI-2 changes from BLOCKED to PASS.
