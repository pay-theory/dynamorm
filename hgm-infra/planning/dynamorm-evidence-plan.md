# dynamorm Evidence Plan (Rubric v0.1)
...
- Controls matrix: `hgm-infra/planning/dynamorm-controls-matrix.md`
- Rubric: `hgm-infra/planning/dynamorm-10of10-rubric.md`
- Roadmap: `hgm-infra/planning/dynamorm-10of10-roadmap.md`
...
| CON-3 | Contract verification output | `hgm-infra/evidence/CON-3-output.log` | `bash scripts/verify-public-api-contracts.sh` |
| COM-1 | Module compile check | `hgm-infra/evidence/COM-1-output.log` | `bash scripts/verify-go-modules.sh` |
...
| SEC-4 | Domain P0 regression tests | `hgm-infra/evidence/SEC-4-output.log` | `bash scripts/verify-encrypted-tag-implemented.sh` |
| CMP-1 | Controls matrix exists | `hgm-infra/planning/dynamorm-controls-matrix.md` | File existence check |
...
| DOC-3 | Rubric + roadmap present | `hgm-infra/planning/dynamorm-10of10-rubric.md` | File existence check |
| DOC-4 | Doc integrity (links, versions) | `hgm-infra/evidence/DOC-4-output.log` | `check_hgm_doc_integrity` (via HGM verifier) |
