...
check_file_exists "CMP-2" "Compliance" "${PLANNING_DIR}/dynamorm-evidence-plan.md"
check_file_exists "CMP-3" "Compliance" "${PLANNING_DIR}/dynamorm-threat-model.md"
...
# === Docs (DOC) ===
check_file_exists "DOC-1" "Docs" "${PLANNING_DIR}/dynamorm-threat-model.md"
